...
fns, shortFns =  rfi.Get_FilesInFolder(".\\NetData\\", [".descriminator"])
aId = 0 #ri.Ask_SelectItem("Select Encoder file", shortFns, 0)    
fn3= fns[aId]
...
if (os.path.isfile(fn1)):            
    ...
    descriminator = rn.RvNeuralDescriminator(fn3)
    
    gan = rn.RvNeuralGAN(generator, descriminator)
    
    imgPath = "{}\\{}\\".format(gan.VideoImagePath, "GAN")   
