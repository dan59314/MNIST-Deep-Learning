...
if (os.path.isfile(fn1)):           
    ...
    saveImgPath = "{}\\{}\\".format(decoder.Get_VideoOutputPath(), "EncoderDecoder")  
    rfi.ForceDir(saveImgPath) #if not os.path.isdir(imgPath): os.mkdir(imgPath)
    rfi.Delete_Files(saveImgPath, [".jpg",".png"])

    saveImgPath1 = "{}\\{}\\".format(decoder.Get_VideoOutputPath(), "EncoderDecoder1")  
...
#            inputX = randomState.randn(encoder.Get_InputNum(),1)  
            ...
            for i in range(Epochs):            
                ...
                weiDiscriminator += stepWei   
                #weiDiscriminator = randomState.randint(10,700)/1000
                nEncode = (encode*(1-weiDiscriminator) + encode1*weiDiscriminator)
